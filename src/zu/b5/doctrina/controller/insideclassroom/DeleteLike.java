 ...
 public class DeleteLike extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if(request.getParameter("type").equals("posts")) {
		    String s = value.deleteLike(request.getParameter("id"), request.getParameter("user_id"), "postlike");
		    writer.write(s);
		}
		else if(request.getParameter("type").equals("comments")) {
		    String s = value.deleteLike(request.getParameter("id"), request.getParameter("user_id"), "commentlike");
		    writer.write(s);
		    
		}
		else if(request.getParameter("type").equals("replies")) {
		
		    String s = value.deleteLike(request.getParameter("id"), request.getParameter("user_id"), "replylike");
		    writer.write(s);
		}
